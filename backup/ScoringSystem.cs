...
namespace Nursing.Scoring
{
    ...
    public class ScoringSystem : MonoBehaviour
    {
        ...
        // 오류 로그
        private List<NewPenaltyRecord> penaltyRecords = new List<NewPenaltyRecord>();
        ...
        public void ApplyPenalty(string errorMessage, PenaltyType penaltyType, string itemName = "", string stepName = "")
        {
            ...
            NewPenaltyRecord record = new NewPenaltyRecord
            {
                ...
                context = $"Item: {itemName}, Step: {stepName}"
            };
        ...
        {
            return new List<NewPenaltyRecord>(penaltyRecords);
        }
